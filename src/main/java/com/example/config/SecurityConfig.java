...
//                        .requestMatchers("/api/v1/students/**").hasAnyRole("SUPER_ADMIN")
                        .requestMatchers("/api/v1/teachers/**").hasAnyRole("SUPER_ADMIN")
                        .requestMatchers("/api/v1/groups/**").hasAnyRole("SUPER_ADMIN", "TEACHER")
                        .requestMatchers("/api/v1/specialties/**").hasAnyRole("SUPER_ADMIN")
...
//                        .requestMatchers("/api/v1/grades/**").hasAnyRole("SUPER_ADMIN", "TEACHER")
                        .requestMatchers("/api/v1/teacher-group-subjects/**").hasAnyRole("SUPER_ADMIN")
